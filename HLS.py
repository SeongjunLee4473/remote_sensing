...
class BandReader:
    def __init__(self, folder_path, product, date):
...
#------------------------------------------------------#
# Example usage:
#s30_reader = HLS.BandReader(base_folder) -> or l30_reader = HLS.BandReader(base_folder)
...
# Other method
#red_data = HLS.BandReader['red'] # Red band by using __getitem__(self, key)
